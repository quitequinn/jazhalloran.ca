...
<img id="fav0" src="<?php echo '//'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']); ?>/fav0.png" style="display: none;"/>
<img id="fav1" src="<?php echo '//'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']); ?>/fav1.png" style="display: none;"/>
<img id="fav2" src="<?php echo '//'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']); ?>/fav2.png" style="display: none;"/>
<img id="fav3" src="<?php echo '//'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']); ?>/fav3.png" style="display: none;"/>
<img id="fav4" src="<?php echo '//'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']); ?>/fav4.png" style="display: none;"/>
...
<script src="<?php echo '//'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']); ?>/src/static/js/touchPunch.js"></script>
<script src="<?php echo '//'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']); ?>/src/static/js/favico-0.3.10.min.js"></script>
